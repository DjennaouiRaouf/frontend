...
const Footer: React.FC = () =>  {
  ...
  useEffect(() => {
      setSignature("assets/img/img4.gif");
  ...
  return (
        <footer className="text-center py-4" style={{"background": "#1A233A"}}>
          <div className="container">
            <div className="row row-cols-1 row-cols-lg-3">
              <div className="col">
                <p className="text-muted my-2" style={{"fontSize": "16px"}}>{"Copyright © 2023 "+fullname }</p>
              </div>
              <div className="col">
